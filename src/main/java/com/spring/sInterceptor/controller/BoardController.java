...
public class BoardController {
	...
	public String getBoardList(Model model) {
		System.out.println("이곳은 board컨트롤러의 boardList메소드입니다");
	...
	public String getBoardInput(Model model) {
		System.out.println("이곳은 board컨트롤러의 boardInput메소드입니다");
	...
	public String getBoardUpdate(Model model) {
		System.out.println("이곳은 board컨트롤러의 boardUpdate메소드입니다");
